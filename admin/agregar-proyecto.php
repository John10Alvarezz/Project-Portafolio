<?php
// ========================================
// ADMIN/AGREGAR-PROYECTO.PHP - CREAR NUEVO PROYECTO
// ========================================
// Este archivo maneja la creación de nuevos proyectos
// Incluye validación, subida de imágenes y guardado en base de datos
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (!empty($_FILES['imagen']['name'])) {
            ...
            elseif ($file['size'] > 5 * 1024 * 1024) {
                ...
                if (move_uploaded_file($file['tmp_name'], $dest)) {
                    $imagen = $imgName; // Guardar el nombre de la imagen
                } else {
    ...
    if (!$error) {
        try {
            ...
            $stmt = $db->prepare('INSERT INTO proyectos (titulo, descripcion, tecnologias, url_github, url_produccion, imagen, estado, orden_mostrar) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
            
            // Ejecutar la consulta con todos los datos del proyecto
            $stmt->execute([$titulo, $descripcion, $tecnologias, $url_github, $url_produccion, $imagen, $estado, $orden_mostrar]);
            
            // Redirigir a la lista de proyectos con mensaje de éxito
            redirect('proyectos.php', 'Proyecto agregado correctamente', 'success');
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Imagen (opcional, JPG/PNG/GIF/WEBP, máx 5MB)</label>
                                <input type="file" 
                                       name="imagen" 
                                       class="form-control">
                            </div>
